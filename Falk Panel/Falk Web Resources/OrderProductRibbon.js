...
Falk.OrderProductRibbon = {

    CalculateLineItemPricing: function (primaryControl) {
        var formContext = primaryControl;

        let panelThickness = Falk.OrderProductRibbon.getLookup(formContext, "tbs_panelthickness", "tbs_thickness");
        let exteriorFinish = Falk.OrderProductRibbon.getLookup(formContext, "tbs_exteriorfinish", "tbs_finish");
        let interiorFinish = Falk.OrderProductRibbon.getLookup(formContext, "tbs_interiorfinish", "tbs_finish");
        let exteriorGauge = Falk.OrderProductRibbon.getLookup(formContext, "tbs_exteriorgauge", "tbs_gauge");
        let interiorGauge = Falk.OrderProductRibbon.getLookup(formContext, "tbs_interiorgauge", "tbs_gauge");
        let exteriorColor = Falk.OrderProductRibbon.getLookup(formContext, "tbs_exteriorcolor", "tbs_color");
        let interiorColor = Falk.OrderProductRibbon.getLookup(formContext, "tbs_interiorcolor", "tbs_color");
        let productId = Falk.OrderProductRibbon.getLookup(formContext, "productid", "product");
        let priceLevelTier = Falk.OrderProductRibbon.getLookup(formContext, "tbs_priceleveltier", "tbs_tier");

        let exteriorColorCategory = formContext.getAttribute("tbs_orderexteriorcolorcategory")?.getValue();
        let interiorColorCategory = formContext.getAttribute("tbs_orderinteriorcolorcategory")?.getValue();
        ...
        var request = {
            entity: { entityType: "salesorderdetail", id: formContext.data.entity.getId().replace(/[{}]/g, "") },
            ...
            OrderExteriorColorCategory: exteriorColorCategory,
            OrderInteriorColorCategory: interiorColorCategory,
            ...
            getMetadata: function () {
                return {
                    ...
                    parameterTypes: {
                        entity: { typeName: "mscrm.salesorderdetail", structuralProperty: 5 },
                        ...
                        OrderExteriorColorCategory: { typeName: "Edm.Int32", structuralProperty: 1 },
                        InteriorColor: { typeName: "mscrm.tbs_color", structuralProperty: 5 },
                        OrderInteriorColorCategory: { typeName: "Edm.Int32", structuralProperty: 1 },
                        InteriorEmboss: { typeName: "Edm.Int32", structuralProperty: 1 },
                        ExteriorEmboss: { typeName: "Edm.Int32", structuralProperty: 1 }
                    },
                    operationType: 0, operationName: "tbs_FalkCustomAPIOrderProductPricingCalculation"
                };
            }
        };
